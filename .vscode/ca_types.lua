...
-- CLASS DECLARATION
--# assume global class BATTLE_MANAGER
--# assume global class BM_CUTSCENE
--# assume global class BM_CAMERA
--# assume global class BM_CAMERA_POS
--# assume global class BM_CAMERA_TARG
--# assume global class BM_SUBTITLES
--# assume global class BM_VECTOR
--# assume global class BM_SFX
--# assume global class GA
--# assume global class GB
--# assume global class GB_PLAYER_ALLIANCE
--# assume global class GB_NON_PLAYER_ALLIANCE
--# assume global class GC
--# assume global class SUNITS
--# assume global class SM
...
--BATTLE MANAGER
--# assume BATTLE_MANAGER.new: method(empire_battle_object: EMPIRE_BATTLE) --> BATTLE_MANAGER
--# assume EMPIRE_BATTLE.new: method() --> EMPIRE_BATTLE
--# assume BATTLE_MANAGER.camera: method() --> BM_CAMERA
--# assume BATTLE_MANAGER.cindy_preload: method(file: string) 
--# assume BATTLE_MANAGER.cindy_playback: method(file: string, clear_anim_scenes: boolean, expire_camera: boolean)
--# assume BATTLE_MANAGER.stop_cindy_playback: method(playback: boolean)
--# assume BATTLE_MANAGER.cache_camera: method()
--# assume BATTLE_MANAGER.out:  method(out:  string | number)
--# assume BATTLE_MANAGER.get_cached_camera_pos: method() --> BM_CAMERA_POS
--# assume BATTLE_MANAGER.get_cached_camera_targ: method() --> BM_CAMERA_TARG
--# assume BATTLE_MANAGER.repeat_callback: method(
--#    callback: function(),
--#    loop: number,
--#    name: string
--#  )
...
-- BATTLE CAMERA
--# assume BM_CAMERA_POS.get_x: method() --> number
--# assume BM_CAMERA_POS.get_y: method() --> number
--# assume BM_CAMERA_POS.get_z: method() --> number
--# assume BM_CAMERA_TARG.get_x: method() --> number
--# assume BM_CAMERA_TARG.get_y: method() --> number
--# assume BM_CAMERA_TARG.get_z: method() --> number

--# assume BM_CAMERA.move_to: method(pos: BM_VECTOR, targ: BM_VECTOR, move_time: number, unknown1: boolean, unknown2: number)
--# assume BM_CAMERA.fade: method(fade: boolean, fade_time: number)

-- BATTLE CUTSCENE
--# assume BM_CUTSCENE.new: method(
--#      name: string,
--#      sunits: SUNITS,
--#      duration: number,
--#      callback: function()
--#  ) --> BM_CUTSCENE
--# assume BM_CUTSCENE.subtitles: method() --> BM_SUBTITLES
--# assume BM_CUTSCENE.set_is_ambush: method(ambush: boolean?)
--# assume BM_CUTSCENE.set_skippable: method(skippable: boolean, callback: function())
--# assume BM_CUTSCENE.set_debug: method(debug: boolean)
--# assume BM_CUTSCENE.enable_debug_timestamps: method(debug: boolean)
--# assume BM_CUTSCENE.action: method(action: function(), time: number)
--# assume BM_CUTSCENE.play_sound: method(sfx: BM_SFX)
--# assume BM_CUTSCENE.show_custom_cutscene_subtitle: method(subtitle: string, style: string, time: number)
--# assume BM_CUTSCENE.hide_custom_cutscene_subtitles: method()
--# assume BM_CUTSCENE.start: method()

-- BATTLE SUBTITLES
--# assume BM_SUBTITLES.set_alignment: method(alignment: string)
--# assume BM_SUBTITLES.clear: method()

-- BATTLE GENERATED ARMY
--# assume GA.attack_on_message: method(message: string)
--# assume GA.reinforce_on_message: method(message: string)
--# assume GA.message_on_casualties: method(message: string, casualties: number)
--# assume GA.sunits: SUNITS
--# assume GA.set_enabled: method(boolean)

-- BATTLE GENERATED BATTLE
--# assume GB.new: method(
--# screen: boolean,
--# prevent_player_deployment: boolean,
--# prevent_ai_deployment: boolean,
--# cutscene_function: function(),
--# debug: boolean
--#) --> GB
--# assume GB.set_objective_on_message: method(message: string, objective: string)
--# assume GB.get_player_alliance_num: method() --> GB_PLAYER_ALLIANCE
--# assume GB.get_non_player_alliance_num: method() --> GB_NON_PLAYER_ALLIANCE
--# assume GB.get_army: method(alliance: GB_PLAYER_ALLIANCE | GB_NON_PLAYER_ALLIANCE, script_name: string) --> GA
--# assume GB.sm: SM


-- BATTLE GENERATED CUTSCENE
--# assume GC.new: method(boolean) --> GC

-- SUNITS

-- SCRIPT MESSAGER
--# assume SM.trigger_message: method(message: string)
...
--# assume global output_uicomponent_on_click: function()
...
-- BATTLE
--# assume global v: function(x: number,y: number,z: number?) --> BM_VECTOR
--# assume global new_sfx: function(file: string) --> BM_SFX
...
--# assume global bm: BATTLE_MANAGER
--# assume global battle_manager: BATTLE_MANAGER
--# assume global empire_battle: EMPIRE_BATTLE
--# assume global cutscene: BM_CUTSCENE
--# assume global generated_battle: GB
--# assume global generated_cutscene: GC